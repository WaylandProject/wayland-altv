...
namespace Wayland.SDK {
    public class CommandEventReceiver : IScript {
        private static CommandRouter _cmdRouter = new CommandRouter();

        [ClientEvent]
        public static void OnPlayerEnterCommand(CustomPlayer player, string cmdName, object[] args) {
